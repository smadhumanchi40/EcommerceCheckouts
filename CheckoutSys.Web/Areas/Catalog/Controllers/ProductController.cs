using CheckoutSys.Application.Constants;
...
using CheckoutSys.Application.Features.Products.Commands.Delete;
...
using CheckoutSys.Web.Extensions;
...
namespace CheckoutSys.Web.Areas.Catalog.Controllers
{
    [Area("Catalog")]
