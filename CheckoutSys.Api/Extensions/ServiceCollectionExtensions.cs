using CheckoutSys.Api.Services;
...
using CheckoutSys.Infrastructure.Identity.Services;
...
namespace CheckoutSys.Api.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\CheckoutSys.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
